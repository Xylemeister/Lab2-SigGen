...
VL_INLINE_OPT void Vsigdelay___024root___sequent__TOP__0(Vsigdelay___024root* vlSelf) {
    ...
    // Init
    SData/*8:0*/ __Vdly__sigdelay__DOT__write;
    ...
    // Body
    __Vdly__sigdelay__DOT__write = vlSelf->sigdelay__DOT__write;
    ...
    if (vlSelf->rst) {
        __Vdly__sigdelay__DOT__write = 0U;
        vlSelf->sigdelay__DOT__read = 0U;
    } else {
        __Vdly__sigdelay__DOT__write = (0x1ffU & ((IData)(1U) 
                                                  + (IData)(vlSelf->sigdelay__DOT__write)));
        vlSelf->sigdelay__DOT__read = (0x1ffU & (((IData)(1U) 
                                                  + (IData)(vlSelf->sigdelay__DOT__write)) 
                                                 - (IData)(vlSelf->offset)));
    }
    vlSelf->sigdelay__DOT__write = __Vdly__sigdelay__DOT__write;
}
