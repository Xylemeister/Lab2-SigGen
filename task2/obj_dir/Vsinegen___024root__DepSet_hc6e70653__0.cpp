...
VL_INLINE_OPT void Vsinegen___024root___sequent__TOP__0(Vsinegen___024root* vlSelf) {
    ...
    if (vlSelf->rst) {
        ...
        __Vdly__sinegen__DOT__address2 = 0U;
    } else if (vlSelf->en) {
        __Vdly__sinegen__DOT__address1 = (0xffU & ((IData)(8U) 
                                                   + (IData)(vlSelf->sinegen__DOT__address1)));
        __Vdly__sinegen__DOT__address2 = (0xffU & ((IData)(vlSelf->sinegen__DOT__address1) 
                                                   + (IData)(vlSelf->incr)));
    } else {
